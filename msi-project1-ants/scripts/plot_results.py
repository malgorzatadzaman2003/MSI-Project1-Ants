...
def main() -> None:
    ...
    plt.title("Porównanie średniej długości tras")
    ...
    plt.title("Porównanie średniego czasu wykonania")
    plt.xlabel("Instancja")
    plt.ylabel("Czas [s]")
    plt.grid(True)
    plt.legend()
    ...
    if boxplot_data:
        ...
        plt.title("Stabilność wyników algorytmów mrówkowych")
    ...
    for algo in stochastic_algorithms:
        ...
        if boxplot_data:
            ...
            plt.title(f"Stabilność wyników {algo.upper()}")
            plt.xlabel("Instancja")
            plt.ylabel("Całkowita długość tras")
            plt.grid(True)
            plt.tight_layout()
    ...
    plt.title("Odchylenie standardowe długości tras")
    plt.xlabel("Instancja")
